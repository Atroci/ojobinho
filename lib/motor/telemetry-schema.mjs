...
export async function jobIdentity(value) {
  ...
  const digest = await webcrypto.subtle.digest('SHA-256', new TextEncoder().encode(canonical)); // ponytail: explicit import keeps Node 18 working (no global crypto there)
